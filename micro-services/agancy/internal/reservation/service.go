...
func (s *service) ListReservationsByToure(ctx context.Context, toureID uuid.UUID) ([]domain.Reservation, error) {
	reservations, err := s.repo.ListByToureID(ctx, toureID)
	if err != nil {
		return nil, err
	}
